...
import com.tiagohs.script_reader.helpers.extensions.setResourceBackgroundColor
...
class AlertSnackBar (
    ...
    companion object {
        ...
        fun make(
            ...
            make(view, type, view?.context.getResourceString(description), duration, onTryAgainClicked)
